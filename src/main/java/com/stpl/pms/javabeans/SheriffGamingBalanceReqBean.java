...
public class SheriffGamingBalanceReqBean implements java.io.Serializable{
	/**
	 * 
	 */
	...
	public String toString() {
		return "SheriffGamingBalanceReqBean [currency=" + currency
				+ ", custom=" + Arrays.toString(custom) + ", game_id="
				+ game_id + ", player_reference=" + player_reference
