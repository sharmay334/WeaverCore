...
/**
 * StTxnPlrWagerRefundMasterDrawGames14 entity. @author MyEclipse Persistence
 * Tools
 */

public class StTxnPlrWagerRefundMasterCasino16 implements java.io.Serializable {
	...
	/** default constructor */
	public StTxnPlrWagerRefundMasterCasino16() {
	}

	/** full constructor */
	public StTxnPlrWagerRefundMasterCasino16(Long transactionId,
			...
			Double bonusPortion, Double depPortion, Double winPortion, Double pendingWinPortion,
