...
/**
 * StTxnPokerJeevesHandMaster entity. @author MyEclipse Persistence Tools
 */

public class StTxnPokerJeevesHandMaster implements java.io.Serializable {
	...
	/** default constructor */
	public StTxnPokerJeevesHandMaster() {
	}

	/** minimal constructor */
	public StTxnPokerJeevesHandMaster(String handNumber) {
		this.handNumber = handNumber;
	}
	
	public StTxnPokerJeevesHandMaster(String handNumber, String startDate,
