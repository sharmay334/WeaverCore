...
/**
 * StVipCriteriaCurrentStatusWagerLiveCasino entity. @author MyEclipse
 * Persistence Tools
 */

public class StVipCriteriaCurrentStatusWagerLiveCasino implements
	...
	/** default constructor */
	public StVipCriteriaCurrentStatusWagerLiveCasino() {
	}

	/** full constructor */
	public StVipCriteriaCurrentStatusWagerLiveCasino(Long playerId,
			Short domainId, Double lastMonthFreq, Long lastMonthCount,
			Double lastMonthValue, Double lastQuarterFreq,
			Long lastQuarterCount, Double lastQuarterValue,
			Double lastYearFreq, Long lastYearCount, Double lastYearValue,
			Double sinceRegiFreq, Long sinceRegiCount, Double sinceRegiValue) {
