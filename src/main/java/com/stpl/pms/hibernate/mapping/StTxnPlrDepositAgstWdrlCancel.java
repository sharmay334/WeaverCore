...
public class StTxnPlrDepositAgstWdrlCancel implements java.io.Serializable {
	...
	/** default constructor */
	public StTxnPlrDepositAgstWdrlCancel() {
	}

	/** minimal constructor */
	public StTxnPlrDepositAgstWdrlCancel(Long transactionId, Long playerId,
			Short domainId, Timestamp transactionDate, Integer currencyId,
			Double amount, Double amountNative, Long refTxnId,
