...
public class StCshPlrDepositResponsePayU implements java.io.Serializable {
	...
	public StCshPlrDepositResponsePayU()
	{
		
	}
	
	
	public StCshPlrDepositResponsePayU(String mihpayId, String mode,
