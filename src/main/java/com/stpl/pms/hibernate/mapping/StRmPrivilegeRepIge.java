...
public class StRmPrivilegeRepIge implements java.io.Serializable {
	...
	/** default constructor */
	public StRmPrivilegeRepIge() {
	}

	/** minimal constructor */
	public StRmPrivilegeRepIge(String functionName, Integer privId,
