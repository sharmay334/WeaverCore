...
public class StTxnPlrTransferFromSubwalletPoker12 implements java.io.Serializable {
	...
	/** default constructor */
	public StTxnPlrTransferFromSubwalletPoker12() {
	}

	/** full constructor 
	 * @param aliasId */
	public StTxnPlrTransferFromSubwalletPoker12(Long transactionId,
			Long playerId, Short domainId, Short aliasId, Timestamp transactionDate,
			Integer currencyId, Double amount, Double amountNative,
			Short vendorId,String gameId,String actionId,String tableId,String gameRefre,Double cashPortion,
			Double bonusPortion, Double pendingWinPortion,String isCancel,Long subwalletId) {
