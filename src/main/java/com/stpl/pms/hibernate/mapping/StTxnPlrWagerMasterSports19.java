...
/**
 * StTxnPlrWagerMasterSports19 entity. @author MyEclipse Persistence Tools
 */

public class StTxnPlrWagerMasterSports19 implements java.io.Serializable,StTxnWagerMaster{
	...
	/** default constructor */
	public StTxnPlrWagerMasterSports19() {
	}

	/** minimal constructor */
	public StTxnPlrWagerMasterSports19(Long transactionId, Long playerId,
	...
	public StTxnPlrWagerMasterSports19(Long transactionId, Long playerId,
			...
			Double processChargeRefund, Double withdrawableBalPortion, String wagerStatus, String isCancel,
			String txnDevice, String userAgent, Long subwalletId, Double rake, Integer deviceLocMapId) {
		this.transactionId = transactionId;
		this.playerId = playerId;
		this.domainId = domainId;
		this.aliasId = aliasId;
