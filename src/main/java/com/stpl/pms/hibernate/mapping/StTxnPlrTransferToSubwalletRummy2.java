...
/**
 * StTxnPlrTransferToSubwalletRummy2 entity. @author MyEclipse Persistence Tools
 */

public class StTxnPlrTransferToSubwalletRummy2 implements java.io.Serializable , StTxnPlrTransferToSubwallet {
	...
	/** default constructor */
	public StTxnPlrTransferToSubwalletRummy2() {
	}

	/** full constructor */
	public StTxnPlrTransferToSubwalletRummy2(Long transactionId, Long playerId,
			Short domainId, Short aliasId, Timestamp transactionDate, Integer currencyId,
			Double amount, Double amountNative, String refTxnNo,
