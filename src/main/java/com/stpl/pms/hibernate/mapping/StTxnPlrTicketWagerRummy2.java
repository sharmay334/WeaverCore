...
public class StTxnPlrTicketWagerRummy2 implements java.io.Serializable,StTxnWagerMaster {
	...
	/** default constructor */
	public StTxnPlrTicketWagerRummy2() {
	}

	/** full constructor */
	public StTxnPlrTicketWagerRummy2(Long transactionId, Long playerId,
			Short domainId, Short aliasId, Long ticketId, Timestamp transactionDate,
			Double ticketCount, Long gameId, String refTxnNo, String gameType,
