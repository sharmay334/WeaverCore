...
/**
 * StTxnPlrWagerMasterRummy2 entity. @author MyEclipse Persistence Tools
 */

public class StTxnPlrWagerMasterRummy2 implements java.io.Serializable, StTxnWagerMaster {
	...
	/** default constructor */
	public StTxnPlrWagerMasterRummy2() {
	}

	/** minimal constructor */
	public StTxnPlrWagerMasterRummy2(Long transactionId, Long playerId,
	...
	public StTxnPlrWagerMasterRummy2(Long transactionId, Long playerId,
			...
			String wagerStatus, String isCancel,String txnDevice,String userAgent,Long subWalletId,Double rake) {
		this.transactionId = transactionId;
		this.playerId = playerId;
		this.domainId = domainId;
