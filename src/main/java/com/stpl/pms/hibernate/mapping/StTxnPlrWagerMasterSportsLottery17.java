...
/**
 * StTxnPlrWagerMasterSportsLottery17 entity. @author MyEclipse Persistence
 * Tools
 */

public class StTxnPlrWagerMasterSportsLottery17 implements java.io.Serializable,StTxnWagerMaster {
	...
	/** default constructor */
	public StTxnPlrWagerMasterSportsLottery17() {
	}

	/** minimal constructor */
	public StTxnPlrWagerMasterSportsLottery17(Long transactionId,
	...
	public StTxnPlrWagerMasterSportsLottery17(Long transactionId,
			...
			Double vatAmountNative, String refTxnNo, Double wgrContriAmt,
			String gameType, String gameName, Short vendorId,
			Double cashPortion, Double bonusPortion, Double depPortion,
			Double winPortion, Double pendingWinPortion,
			Double subwalletPortion, Double processChargeRefund,
			Double withdrawableBalPortion,String wagerStatus, String isCancel, String txnDevice,
			String userAgent, Long subwalletId, Double rake, Integer deviceLocMapId) {
		this.transactionId = transactionId;
		this.playerId = playerId;
		this.domainId = domainId;
		this.aliasId = aliasId;
