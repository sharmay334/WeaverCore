...
public class StTxnPlrWagerRefundMasterCasino4 implements java.io.Serializable {
	...
	/** default constructor */
	public StTxnPlrWagerRefundMasterCasino4() {
	}

	/** full constructor */
	public StTxnPlrWagerRefundMasterCasino4(Long transactionId,
