...
/**
 * StTxnPlrWinningMasterCasino8 entity. @author MyEclipse Persistence Tools
 */

public class StTxnPlrWinningMasterCasino8 implements java.io.Serializable {
	...
	/** default constructor */
	public StTxnPlrWinningMasterCasino8() {
	}
	 ...
	 */
	public StTxnPlrWinningMasterCasino8(Long transactionId, Long playerId,
			...
			Integer gamehashId, Integer gamerunId, Double vatAmount,
			String refTxnNo, String status, Short vendorId, Double cashPortion,
