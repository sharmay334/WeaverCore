...
/**
 * StTxnPlrWinningMasterCasino10 entity. @author MyEclipse Persistence Tools
 */

public class StTxnPlrWinningMasterCasino10 implements java.io.Serializable {
	...
	/** default constructor */
	public StTxnPlrWinningMasterCasino10() {
	}
	 ...
	 */
	public StTxnPlrWinningMasterCasino10(Long transactionId, Long playerId,
			Short domainId, Timestamp transactionDate, Double winningAmount,
			Double tdsAmount, Double amount, Integer currencyId,
			Integer gameId, Integer roundId, String gameSessionId,
