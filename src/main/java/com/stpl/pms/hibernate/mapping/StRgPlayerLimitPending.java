...
/**
 * StRgPlayerLimitPending entity. @author MyEclipse Persistence Tools
 */

public class StRgPlayerLimitPending implements java.io.Serializable {
	...
	/** default constructor */
	public StRgPlayerLimitPending() {
	}

	/**
	 * full constructor*/
	public StRgPlayerLimitPending(Long playerId, Short domainId,
			Integer nogWagerDaily, Integer nogWagerWeekly,
			Integer maxLossDaily, Integer maxLossWeekly, Integer maxWagerDaily,
			Integer maxWagerWeekly, Integer maxDepositDaily,
			Integer maxDepositWeekly, Integer nogWagerDailyRummy,
			Integer nogWagerWeeklyRummy, Integer nogWagerDailyCasino,
			Integer nogWagerWeeklyCasino, Integer nogWagerDailyGames,
			Integer nogWagerWeeklyGames, Integer nogWagerDailyBingo,
			Integer nogWagerWeeklyBingo, Integer nogWagerDailyLiveCasino,
			Integer nogWagerWeeklyLiveCasino, Integer nogWagerDailyPoker,
			Integer nogWagerWeeklyPoker, Integer nogWagerDailySports,
			Integer nogWagerWeeklySports, Integer maxLossDailyRummy,
			Integer maxLossWeeklyRummy, Integer maxLossDailyCasino,
			Integer maxLossWeeklyCasino, Integer maxLossDailyGames,
			Integer maxLossWeeklyGames, Integer maxLossDailyBingo,
			Integer maxLossWeeklyBingo, Integer maxLossDailyLiveCasino,
			Integer maxLossWeeklyLiveCasino, Integer maxLossDailyPoker,
			Integer maxLossWeeklyPoker, Integer maxLossDailySports,
			Integer maxLossWeeklySports, Integer maxWagerDailyRummy,
			Integer maxWagerWeeklyRummy, Integer maxWagerDailyCasino,
			Integer maxWagerWeeklyCasino, Integer maxWagerDailyGames,
			Integer maxWagerWeeklyGames, Integer maxWagerDailyBingo,
			Integer maxWagerWeeklyBingo, Integer maxWagerDailyLiveCasino,
			Integer maxWagerWeeklyLiveCasino, Integer maxWagerDailyPoker,
			Integer maxWagerWeeklyPoker, Integer maxWagerDailySports,
			Integer maxWagerWeeklySports, Integer maxWagerDailyDrawGames,
			Integer maxWagerWeeklyDrawGames, Integer maxLossDailyDrawGames,
			Integer maxLossWeeklyDrawGames, Integer nogWagerDailyDrawGames,
			Integer nogWagerWeeklyDrawGames) {
