...
/**
 * StRummyPrivilegeRepMgmt entity. @author MyEclipse Persistence Tools
 */

public class StRummyPrivilegeRepMgmt implements java.io.Serializable {
	...
	/** default constructor */
	public StRummyPrivilegeRepMgmt() {
	}

	/** minimal constructor */
	public StRummyPrivilegeRepMgmt(String functionName, Integer privId,
