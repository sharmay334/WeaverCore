...
/**
 * StVipCriteriaCurrentStatusDeposit entity. @author MyEclipse Persistence Tools
 */

public class StVipCriteriaCurrentStatusDeposit implements java.io.Serializable {
	...
	/** default constructor */
	public StVipCriteriaCurrentStatusDeposit() {
	}

	/** full constructor */
	public StVipCriteriaCurrentStatusDeposit(Long playerId, Short domainId,
