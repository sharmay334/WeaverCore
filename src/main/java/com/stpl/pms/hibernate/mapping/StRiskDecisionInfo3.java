...
/**
 * StRiskDecisionInfo3 entity. @author MyEclipse Persistence Tools
 */

public class StRiskDecisionInfo3 implements java.io.Serializable,
		DecisionInfoMarkerBean {
