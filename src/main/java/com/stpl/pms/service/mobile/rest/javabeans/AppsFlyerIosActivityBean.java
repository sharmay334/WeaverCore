...
public class AppsFlyerIosActivityBean implements Serializable 
{
	private static final long serialVersionUID = 1L;
	private Long iosActivityId;
	...
	public Long getIosActivityId() {
		return iosActivityId;
	}
	public void setIosActivityId(Long iosActivityId) {
		this.iosActivityId = iosActivityId;
	}
	...
	public AppsFlyerIosActivityBean()
	{
		
	}
	public AppsFlyerIosActivityBean(String appId, String platform,
			String clickTime, String installTime, String agency,
			String mediaSource, String campaign, String fbCampaignName,
			String fbCampaignId, String fbAdsetName, String fbAdsetId,
			String fbAdgroupName, String fbAdgroupId, String afSiteId,
			String costPerInstall, String countryCode, String city, String ip,
			String wifi, String language, String appsFlyerDeviceId,
			String customerUserId, String idfa, String mac, String deviceName,
			String deviceType, String osVersion, String sdkVersion,
			String appVersion, String eventType, String eventName,
			String eventValue, String currency, String eventTime,
			String afSub1, String afSub2, String afSub3, String afSub4,
			String afSub5, String clickUrl, String attributionType,String is_retargeting,String re_targeting_conversion_type) {
		this.appId = appId;
		this.platform = platform;
		this.clickTime = clickTime;
		this.installTime = installTime;
