...
package com.stpl.pms.maxmind.geoip;
 ...
 * log.info("The country is: " + country.getName());
 * log.info("The country code is: " + country.getCode());
 * </pre>
 *
  ...
  "BL","MF", "BQ"};
    ...
    public synchronized Location getLocationV6(InetAddress addr) {
		...
		if (record.countryCode == "US") {
            ...
            log.error("IO Exception while seting up segments");
        }
        return record;
    }
	...
	int [] x = new int[2];
        ...
        log.error("Error seeking country while seeking " + addr.getHostAddress() );
        return 0;
    }
    /**
